...
void loop() {
  ...
  DEBUG_SERIAL.print(F(", Present Current: "));DEBUG_SERIAL.print(present_current[0]);DEBUG_SERIAL.print(" ");
  ...
  DEBUG_SERIAL.print(F(", Present Current: "));DEBUG_SERIAL.print(present_current[1]);DEBUG_SERIAL.print(" ");
