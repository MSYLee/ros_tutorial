...
bool controlMotor(const float wheel_radius, const float wheel_separation, float* value)
{
  ...
  wheel_velocity_cmd[LEFT]  = constrain(wheel_velocity_cmd[LEFT]  * 41.69988758 / wheel_radius, MIN_LINEAR_VELOCITY, MAX_LINEAR_VELOCITY);
  wheel_velocity_cmd[RIGHT] = constrain(wheel_velocity_cmd[RIGHT] * 41.69988758 / wheel_radius, MIN_LINEAR_VELOCITY, MAX_LINEAR_VELOCITY);
